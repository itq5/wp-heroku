...
<div class="swiper-plane">
    ...
    <el-collapse>
        <draggable v-model="set.index.swiperlist" group="swiper"  handle=".drag-title-img">
            <div v-for="(item,index) in set.index.swiperlist" :key="index" class="drag-item">
                <el-collapse-item>
                    <template slot="title">
                        <div class="drag-title">
                            <img src="<?php echo file_get_img_url('bars.svg') ?>" class="drag-title-img">
                            <span class="index-card-plane-thumbnail"><img :src="item.imgurl"></span>
                            <span class="swiper-title">{{item.imgurl}}</span>
                            <span class="swiper-colbtn" @click.stop="delSwiper(index)"><i
...
<div class="index-card-plane">
    ...
    <el-collapse>
        <draggable v-model="set.index.postcard" group="indexcard"  handle=".drag-title-img">

            <div v-for="(item,index) in set.index.postcard" :key="index" class="drag-item">
                <el-collapse-item>
                    <template slot="title">
                        <div  class="drag-title">
                            <img src="<?php echo file_get_img_url('bars.svg') ?>" class="drag-title-img">
